...
namespace Projekt2.Controllers
{
    ...
    public class CityController : ApiController
    {
        ...
        [HttpGet]
        [Route("city")]
        public async Task<HttpResponseMessage> GetAllCityAsync([FromUri] Sorter sorter, [FromUri] CityFilter filter, Pager pager )
        {
            List<CityRest> cities = (await _cityService.GetAllCityAsync(sorter,filter,pager)).ConvertAll(ConvertFromDomainToRest);
