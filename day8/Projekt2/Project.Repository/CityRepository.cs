...
namespace Project.Repository
{
    public class CityRepository : ICityRepository
    {
        ...
        public async Task<List<ICity>> GetCitiesAsync(Sorter sorter, CityFilter filter, Pager pager)
        {
            SqlCommand command = new SqlCommand("SELECT * FROM City"+sorter.SQLMethod()+filter.SQlMethod(), _connection);
