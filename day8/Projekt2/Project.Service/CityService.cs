...
namespace Project.Service
{
    public class CityService : ICityService
    {
        ...
        public async Task<List<ICity>> GetAllCityAsync(Sorter sorter,CityFilter filter, Pager pager)
        {
            return await _cityRepository.GetCitiesAsync(sorter,filter,pager);
        }
